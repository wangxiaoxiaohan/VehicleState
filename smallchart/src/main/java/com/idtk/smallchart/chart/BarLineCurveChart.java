...
//    protected ArrayList<ChartRender> chartRenderList = new ArrayList<>();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i("BarLineCurbeChart","onSizeChanged");
    ...
    protected void onDraw(Canvas canvas) {
        Log.i("BarLineCurbeChart","onDraw");
    ...
    public void computeXAxis() {
        Log.i("BarLineCurbeChart","computeXAxis");
        mComputeXAxis.computeXAxis(mDataList);
    }

    @Override
    public void computeYAxis() {
        Log.i("BarLineCurbeChart","computeYAxis");
    ...
    public int getCurrentWidth() {
        ...
        if (mDataList!=null&&mDataList.size()>0){
            ...
            Log.i("BarLineCurbeChart","getCurrentWidth wrapSize="+wrapSize);
        }else {
            wrapSize = 0;
        }
//        LogUtil.d("TAGX",mXAxisData.getMaximum()+"__"+mXAxisData.getMinimum()+"__"+mXAxisData.getInterval());
    ...
    public int getCurrentHeight() {
        ...
        if (mDataList!=null&&mDataList.size()>0){
            ...
            Log.i("BarLineCurbeChart","getCurrentHeight wrapSize="+wrapSize);
        }else {
            wrapSize = 0;
        }
...
//        this.YAxisUnit = YAxisUnit;
    ...
    @Override
    public void setAverageValueColor(int color) {
        mYAxisData.setAverageValueColor(color);
    }

    @Override
    public void setShowAverageValue(boolean isShow) {
        mYAxisData.setShowAverageValue(isShow);
    }
}
