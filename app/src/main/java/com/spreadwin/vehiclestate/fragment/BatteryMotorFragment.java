...
public class BatteryMotorFragment extends Fragment implements RadioGroup.OnCheckedChangeListener{

    private String TAG="EnergyConsumptionView";
    public static BatteryMotorFragment energyConsumptionFragment;
    public  View mECView;
    ...
    public static BatteryMotorFragment getInstance(){
        if (energyConsumptionFragment==null){
            energyConsumptionFragment=new BatteryMotorFragment();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mECView=inflater.inflate(R.layout.health_degree_view, container, false);
        return mECView;
    }
