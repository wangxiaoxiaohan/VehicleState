...
public class DrivingParingFragment extends Fragment implements RadioGroup.OnCheckedChangeListener{

    private String TAG="EnergyConsumptionView";
    public static DrivingParingFragment energyConsumptionFragment;
    public  View mECView;
    ...
    public static DrivingParingFragment getInstance(){
        if (energyConsumptionFragment==null){
            energyConsumptionFragment=new DrivingParingFragment();
        }
