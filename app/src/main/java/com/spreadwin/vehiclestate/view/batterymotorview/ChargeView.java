...
public class ChargeView extends RelativeLayout{
    ...
    public ChargeView(Context context) {
        ...
        mECView = LayoutInflater.from(context).inflate(R.layout.charge_view, this);
    }
    ...
    public View getView(Activity activity){
        ...
        if (mECView == null) {
            mECView = LayoutInflater.from(mContext).inflate(R.layout.charge_view, this);
        }
